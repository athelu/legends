...
**Benefit:** When using Pneuma Strike, you can spend 4 Energy (instead of 2) to channel two elements simultaneously:
  ...
  - Count total successes across both checks
    - **3-4 total successes:** Deal +3d8 damage, choose damage type or split
    - **1-2 total successes:** Deal +2d8 damage, choose damage type or split
    - **0 successes:** Deal +1d8, choose type
...
**Benefit:** Once per short rest, can spend 6 Energy to release a devastating elemental burst in a 15-foot cone:
  ...
  - Creatures in area make Reflex save (opposed by your weaving roll)
    - **2 successes:** 3d8 elemental damage
    - **1 success:** 2d8 elemental damage
    - **0 successes:** 1d8 elemental damage (lose opposed check)
...
**Benefit:** For one element you have Pneuma Strike, you can spend 4 Energy as a [Combat] action to shroud yourself in that element for 1 minute:
  - **Fire:** Deal 1d8 fire damage to creatures that hit you with melee attacks
...
**Benefit:** Subtract 1 from both dice on Medicine checks and heal 1d8 additional HP
**Usage:** Passive
**Keyword:** [Skill]
...
**Benefit:** Choose one elemental energy (Fire, Water, Air, or Earth) when taking this feat. Once per turn when you hit with an unarmed strike or monk weapon, you can spend 2 Energy to empower the strike:
  ...
  - **1 success:** Deal +1d8 elemental damage
  - **2+ successes:** Deal +2d8 elemental damage
