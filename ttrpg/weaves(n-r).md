...
**Saving Throw:** None (creates zone of suppression)  
**Success Scaling:** 0 = fails, 1 = 1 round, 2 = full effect, 3 = 1 hour, 4 = 8 hours

## O

### Object Seeking
**Primary Energy:** Space 4 (sensing specific object's location)  
**Supporting Energy:** Time 2 (duration 10 minutes)  
**Range:** Self (1,000 feet sensing range)  
**Duration:** 10 minutes  
**Total Cost:** 6 Energy  
**Action:** Complex weave (2 actions)  
**Weaving Roll:** Space Potential + Space Mastery / Time Potential + Time Mastery  
...
**Effect:** Create a passage at close range up to 5 feet wide, 8 feet tall, and 20 feet deep through wood, plaster, or stone. When weave ends, creatures still in passage are ejected safely.  
**Saving Throw:** None (environmental manipulation)  
**Success Scaling:** 0 = fails, 1 = 10 feet deep (1 round), 2 = full effect, 3 = 40 feet deep (10 minutes), 4 = permanent passage
...
**Action:** Complex weave (2 actions)  
**Weaving Roll:** Space Potential + Space Mastery / Time Potential + Time Mastery  
**Effect:** Target at touch can see through illusory effects, invisible creatures/objects, ethereal plane, darkness (magical and normal), disguises, Beastial Transformations, and see true forms of shapechangers. Can see into the Ethereal Plane up to 60 feet.  
**Saving Throw:** None (beneficial buff, willing targets only)  
**Success Scaling:** 0 = fails, 1 = 1 minute, 2 = full effect, 3 = 1 hour, 4 = 8 hours or 120 feet ethereal sight
...
**Success Scaling:** 0 = fails, 1 = 1 duplicate (1 round), 2 = 3 duplicates (full effect), 3 = 4 duplicates (10 minutes), 4 = 6 duplicates (1 hour)

### Phantom Image
**Primary Energy:** Space 4 (visual illusion + medium range + 15ft cube)  
**Supporting Energy:** Time 2 (duration 1 minute)  
**Range:** Medium, 60 ft. (15-foot cube)  
**Duration:** 1 minute  
**Total Cost:** 6 Energy  
**Action:** Complex weave (2 actions)  
**Weaving Roll:** Space Potential + Space Mastery / Time Potential + Time Mastery  
**Effect:** Create a visual illusory effect of object, creature, or phenomenon at medium range in 15ft cube. Can move illusory effect with action. No sound, smell, or other sensory elements. Physical interaction reveals illusory effect.  
**Saving Throw:** Perception vs Space Mastery (to disbelieve if suspicious)  
**Success Scaling:** 0 = fails, 1 = 1 round, 2 = full effect, 3 = 10 minutes, 4 = 30ft cube (1 hour)
...
**Success Scaling:** 0 = fails, 1 = 10 minutes, 2 = 1 hour, 3 = 24 hours, 4 = 10 days

### Project Image
**Primary Energy:** Space 8 (illusory duplicate + medium range)  
**Supporting Energy:** Time 3 (duration 10 minutes)  
**Range:** Medium, 60 ft. (can move up to 120 feet away)  
**Duration:** 10 minutes  
**Total Cost:** 11 Energy  
**Action:** Complex weave (2 actions)  
**Weaving Roll:** Space Potential + Space Mastery / Time Potential + Time Mastery  
**Effect:** Create an illusory duplicate of yourself that you can see and hear through (can move up to 120 feet away). Can cast weaves from duplicate's location. Duplicate can move and speak. Physical interaction reveals it as illusory effect.  
**Saving Throw:** Perception vs Space Mastery (to recognize as illusory effect)  
**Success Scaling:** 0 = fails, 1 = 1 minute, 2 = full effect, 3 = 1 hour, 4 = long range (240 feet, 8 hours)
...
**Saving Throw:** None (beneficial buff, willing targets only)  
**Success Scaling:** 0 = fails, 1 = 1 minute, 2 = full effect, 3 = 1 hour, 4 = Greater Resistance (+2 DR, 8 hours)

## R

### Radiant Bolt
**Primary Energy:** Positive 4 (radiant energy, damage)  
**Supporting Energy:** Space 2 (medium range) / Time 1 (duration 1 round)  
**Range:** Medium, 60 ft.  
...
**Supporting Energy:** Space 4 (medium range + 60ft radius) / Time 3 (duration 10 minutes)  
...
**Effect:** Bright light fills a 60ft radius sphere at medium range. Acts as sunlight for creatures vulnerable to it. Dispels magical darkness of equal or lower energy.  
**Saving Throw:** None (creates light)  
**Success Scaling:** 0 = fails, 1 = 1 minute, 2 = full effect, 3 = 1 hour, 4 = 8 hours
...
**Effect:** When hit by an attack or targeted by Unerring Bolt, gain Fortune on your defense roll (or automatically block Unerring Bolt). Applies to the triggering attack and any others until end of your next turn.  
**Saving Throw:** None (defensive reaction)  
**Success Scaling:** 0 = fails, 1 = triggering attack only, 2 = until end of next turn, 3 = +2 DR instead of Fortune, 4 = +4 DR (1 minute)
