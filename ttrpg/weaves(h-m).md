...
-   **Effect:** Humanoid target at medium range (60ft) makes Will save. If you win, target is Paralyzed. Target can repeat save at end of each turn to break free.
-   **Success Scaling:** Net successes: 1 = 1 round, 2 = full effect, 3 = target has Misfortune on saves, 4 = 10 minutes or affects 2 targets
...
-   **Effect:** Target takes 8 cold damage. No attack roll, weaving successes determine hit quality.
-   **Success Scaling:** 0 = miss, 1 = half damage, 2 = full damage (8), 3 = +8 damage (16 total), 4 = +16 damage and slowed (24 total)
...
-   **Effect:** Target at close range (30ft) rises vertically up to 20 feet (your choice). Can change altitude by 20 feet each round. Target can't move horizontally except by pushing off objects. Unwilling targets get Fortitude save to resist.
-   **Success Scaling:** Net successes (if unwilling): 1 = 1 minute, 2 = full effect, 3 = 1 hour, 4 = can move horizontally (8 hours)

### Life Drain
-   **Primary Energy:** Negative 2 (siphoning life force, moderate damage + healing)
-   **Supporting Energy:** Air 1 (close range 30ft)
-   **Total Cost:** 3 Energy
-   **Action:** Complex weave (2 actions)
...
-   **Effect:** All creatures in line take 16 damage. Targets make Reflex saves to reduce.
-   **Success Scaling:** Net successes after saves: 0 = no damage, 1 = half, 2 = full (16), 3 = +8 (24), 4 = +16 (32) and Stunned
