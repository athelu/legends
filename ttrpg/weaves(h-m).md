...
**Saving Throw:** None
**Targeting Success Scaling:** 0 = fails, 1 = half strength (4), 2 = full strength (8), 3 = enhanced strength (12)
...
**Targeting Success Scaling:** 0 = fails, 1 = half damage (4), 2 = full damage (8), 3 = enhanced damage (16) + revealed
...
**Description:** Learn the properties of one magic item or active weave, including how to use it and any requirements. Can also reveals if item is cursed (but not the curse's nature).
**Saving Throw:** None
...
**DR Interaction:** Half DR
**Targeting Success Scaling:** 0 = fails, 1 = half damage (4) heal (2), 2 = full damage (8) heal (4), 3 = enhanced damage (16) heal (8) + weakened
...
**Saving Throw:** None
**Targeting Success Scaling:** 0 = fails, 1 = suppress effect (1 hour), 2 = remove 1 effect, 3 = removes 2 effects
...
**Description:** Target heals 8 HP. Can target creatures at 0 HP to stabilize and restore consciousness.
**Saving Throw:** None
**Targeting Success Scaling:** 0 = fails, 1 = heal (4), 2 = heal (8), 3 = heal (12)
...
**Saving Throw:** None
**Targeting Success Scaling:** 0 = fails, 1 = heal (8), 2 = heal (16), 3 = heal (24)
