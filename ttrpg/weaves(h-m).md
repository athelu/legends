...
**Targeting Success Scaling:**
- 0 = fails
- 1 = basic function only
- 2 = full properties
- 3 = learn curse details
...
**Targeting Success Scaling:**
- 0 = fails
- 1 = half damage (4) heal (2)
- 2 = full damage (8) heal (4)
- 3 = enhanced damage (16) heal (8) + weakened
...
**Targeting Success Scaling:**
- 0 = fails
- 1 = suppress condition (10 minutes)
- 2 = remove 1 condition
- 3 = remove 2 conditions
