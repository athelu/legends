...
-   **Success Scaling (Net successes if unwilling = Your successes - Their successes):** 1 = 1 minute, 2 = full effect, 3 = 1 hour, 4 = can move horizontally (8 hours)
...
-   **Area Effect Note:** Line affects all creatures in its path (typically 2-4 targets). Unlike Fireball's radius, enemies can avoid being in the line through positioning.
-   **Success Scaling (Net successes = Your successes - Their successes):** 0 = no damage, 1 = half damage (14), 2 = full damage (28), 3 = +8 damage (36 total), 4 = +16 damage (44 total)
