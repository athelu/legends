...
**Success Scaling:** 0 = fails, 1 = half damage (14), 2 = full damage (28), 3 = enhanced damage (36), 4 = maximum damage (44), 5 = maximum damage (44) + prone
...
**Saving Throw:** None
**Success Scaling:** 0 = fails, 1 = 1 round, 2 = 1 minute, 3 = 10 minutes
...
**Saving Throw:** None
**Success Scaling:** 0 = fails, 1 = half strength (4), 2 = full strength (8), 3 = enhanced strength (12), 4 = maximum strength (16), 5 = maximum strength (16)
...
**Success Scaling:** 0 = fails, 1 = half damage (4), 2 = full damage (8), 3 = enhanced damaage (16), 4 = maximum damage (24), 5 = maximum damage (24) + revealed
...
**Success Scaling:** 0 = fails, 1 = half damage (4), 2 = full damage (8), 3 = enhanced damage (16), 4 = maximum damage (24), 5 = maximum damage (24) + slowed
...
**Description:** Learn the properties of one magic item or active weave, including how to use it and any requirements. Also reveals if item is cursed (but not the curse's nature).  
**Saving Throw:** None
**Success Scaling:** 0 = fails, 1 = basic function only, 2 = full properties, 3 = learn curse details
...
**Saving Throw:** Will
**Success Scaling:** 0 = fails, 1 = 1 round, 2 = 1 minute (8), 3 = 1 minute (8), 4 = 1 minute (16), 5 = 1 minute (16) + disoriented
...
**Description:** Target takes 8 negative damage. You heal HP equal to half the damage dealt. This is an attack weave—no saving throw allowed.  
**Applies Effects:** weakened
**Saving Throw:** None
**Damage Type:** Negative (energy)  
**DR Interaction:** Half DR
**Success Scaling:** 0 = fails, 1 = half damage (4) heal (2), 2 = full damage (8) heal (4), 3 = enhanced damage (16) heal (8), 4 = maximum damage (24) heal (12), 5 = maximum damage (24) heal (12) + weakened
...
**DR Interaction:** Half DR
**Success Scaling:** 0 = fails, 1 = half damage (14), 2 = full damage (28), 3 = enhanced damage (36), 4 = maximum damage (44), 5 = maximum damage (44) + stunned
...
**Description:** Touch a creature and end one of the following: one curse (including attunement to cursed item), petrification, reduction of attribute scores, reduction of max HP. The weave removes only one effect per casting.  
**Saving Throw:** None
**Success Scaling:** 0 = fails, 1 = suppress effect (1 hour), 2 = remove 1 effect, 3 = removes 2 effects
...
**Action:** Complex weave (2 actions)  
**Weaving Roll:** Space Potential + Space Mastery / Time Potential + Time Mastery  
**Description:** Alter your appearance, gain aquatic adaptation, or grow natural weapons (4 damage). Appearance changes are cosmetic only (height 1 foot, weight 50 lbs, features change). Natural weapons count as light weapons.  
**Saving Throw:** None
**Success Scaling:** 0 = fails, 1 = 1 round, 2 = 1 minute, 3 = 10 minutes, 4 = 1 hour, 5 = 4 hours
...
**Description:** Target heals 8 HP. Can target creatures at 0 HP to stabilize and restore consciousness.  
**Saving Throw:** None
**Success Scaling:** 0 = fails, 1 = heal (4), 2 = heal (8), 3 = heal (12)
...
**Saving Throw:** None
**Success Scaling:** 0 = fails, 1 = heal (8), 2 = heal (16), 3 = heal (24), 4 = heal (32), 5 = heal (40)
...
**Action:** Complex weave (2 actions)  
**Weaving Roll:** Space Potential + Space Mastery / Time Potential + Time Mastery  
**Description:** Humanoid target at medium range makes Will save. Compare your weaving successes to their save successes. If you have more, you control target's actions (won't take obviously harmful actions). Target can repeat save when taking damage (1 success ends effect).  
**Saving Throw:** Will
**Success Scaling:** 0 = fails, 1 = 1 round, 2 = 1 minute, 3 = 10 minutes, 4 = 1 hour, 5 = 4 hours
...
**Action:** Complex weave (2 actions)  
**Weaving Roll:** Space Potential + Space Mastery / Time Potential + Time Mastery  
**Description:** Create a twisting pattern of colors in 30-foot cube at medium range. All creatures in area make Will saves. Compare your weaving successes to each target's save successes. Those you beat become Charmed and Incapacitated, staring at the pattern. Weave ends for a creature if it takes damage or if someone uses action to shake them (1 success ends effect). Creatures immune to charm are immune.  
**Applies Effects:** charmed, Incapacitated
**Saving Throw:** Will
**Success Scaling:** 0 = fails, 1 = 1 round, 2 = 1 minute, 3 = 10 minutes, 4 = 10 minutes (40-foot cube), 5 = 10 minutes (40-foot cube)
...
**Action:** Complex weave (2 actions)  
**Weaving Roll:** Positive Potential + Positive Mastery  
**Description:** Touch a creature and end one condition affecting it: Blinded, Deafened, Paralyzed, or Poisoned.  
**Saving Throw:** None
**Success Scaling:** 0 = fails, 1 = suppress condition (10 minutes), 2 = remove 1 condtion, 3 = remove 2 conditions
...
**Description:** Target at touch and equipment become a misty cloud. Fly speed 10 feet, DR 8 against nonmagical damage, can pass through small openings. Cannot attack, cast weaves, or manipulate objects.  
**Saving Throw:** None
**Success Scaling:** 0 = fails, 1 = 1 minute, 2 = 10 minutes, 3 = 1 hour, 4 = 1 hour (20 feet fly speed), 5 = 4 hours (20 feet fly speed)