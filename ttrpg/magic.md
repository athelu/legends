...
Magic in Athelu is the shaping of the Eight Energies through pneuma, ritual knowledge, devotion, force of self, or more indirect methods such as alchemy. It is not subtle. Weaves, wards, divine workings, and infused objects all manifest as visible violet light, glyphs, motes, resonant sounds, or other unmistakable signs that supernatural power is being used.

## The Eight Energies

All standard magic works by channeling one or more of the Eight Energies:
...
Standard magical casting follows a two-stage process:

1. **Declare the effect** you want and choose the energy combination that produces it.
2. **Spend Energy** based on the desired power, range, duration, area, or supporting effects.
3. **Make the weaving roll** to determine how cleanly you shaped the energies.
4. **Apply overspending penalties** if you spent more than your Mastery in any used energy.
5. **Make the targeting roll** unless the effect targets a willing recipient or says otherwise.

### Simple Weaves
Simple weaves use one energy, cost 1 action, and are the fast, combat-safe expressions of magic. They are typically limited in scope and usually remain touch or very close range.

### Complex Weaves
Complex weaves use a Primary Energy plus one or more supporting energies, cost 2 actions, and create the larger battlefield, utility, prophecy, transformation, and long-duration effects of the system. In melee, these are slower and more vulnerable than simple weaves.

### Targeting and Save Resolution
...
## Alchemical Preparations and Weaves
...
Use this document as the overview of how magic fits together in the setting. For the exact mechanical rules of potentials, mastery, weaving rolls, targeting, duration scaling, and effect categories, see **magic_system.md**. For the exact benefits and structure of each magical tradition, see **traits.md**.
