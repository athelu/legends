...
- **Special:** Provides partial cover when crouching (+2 DR against ranged attacks if you don\'t move that round)

### Pavise/Tower Shield (Heavy Shield)
...
- Planted Mode: Use 1 [Move] action to plant shield. While planted:
  ...
  - You and one adjacent ally gain +4 DR against ranged attacks from that direction
  - You cannot move without using 1 [Move] action to retrieve it
...
|                    |        |                                     |                                                |                                             |
| Battleaxe          | 8/9    | Versatile                           | Slashing                                       | Powerful chopping weapon                    |
...
| Greataxe           | 10     | Two-Handed                          | Slashing                                       | Devastating chops                           |
| Greatsword         | 10     | Two-Handed, Alternate Strike        | Slashing (primary), Bludgeoning (crossguard 5) | Massive blade                               |
...
| Longsword          | 8/9    | Versatile, Alternate Strike         | Slashing (primary), Bludgeoning (pommel 4)     | Classic knightly weapon                     |
| Mace               | 6      | Standard                            | Bludgeoning                                    | Simple, reliable                            |
| Maul               | 10     | Two-Handed                          | Bludgeoning                                    | Heavy crushing weapon                       |
| Morningstar        | 8      | Standard, Multi-Type                | Bludgeoning/Piercing                           | Spiked mace                                 |
| Poleaxe            | 10     | Two-Handed, Multi-Type              | Slashing/Piercing/Bludgeoning                  | Versatile head design                       |
| Quarterstaff       | 6      | Two-Handed                          | Bludgeoning                                    | Simple, defensive                           |
| Sap                | 4      | Light, Standard                     | Bludgeoning                                    | Non-lethal option                           |
| Scimitar           | 6      | Light, Multi-Type                   | Slashing/Piercing                              | Curved blade                                |
...
| War Pick           | 8      | Standard, Multi-Type                | Piercing/Bludgeoning                           | Armor-piercing spike                        |
| Warhammer          | 8      | Standard                            | Bludgeoning                                    | Heavy impact                                |
| Warhammer (spiked) | 8      | Standard, Multi-Type                | Bludgeoning/Piercing                           | Spike on reverse                            |
|                    |        |                                     |                                                |                                             |
