...
#### Ritual Casting
- **Effect:** You can cast any weave as a 10-minute ritual for half Energy cost (minimum 1). Cannot be used in combat. Your intellectual understanding of magic allows you to carefully construct weaves outside of combat pressure.
...
- **Effect:** All enemies within range who attacked an ally since your last turn take Fire damage equal to your Tier × 8. Each target makes Reflex save (Agility + Luck). Compare your Wisdom + Fire Mastery to their save successes. Net successes determine damage: Net 0 or less = No damage, Net 1 = Half damage (Tier × 4), Net 2+ = Full damage (Tier × 8).
- **Damage Type:** Fire (energy), Half DR
- **Usage:** Uses 1 Channel Divinity

#### Rally the Troops (Alkira)
...
#### Divine Judgment (Athore)
- **Action Cost:** 2 [Combat] actions
- **Range:** 60 feet
- **Effect:** Target one creature you can see. Make opposed check: your Wisdom + Positive Mastery vs their Wisdom + Luck (Will save). If you win by 1+ net successes, they are Stunned until end of their next turn as Athore's judgment weighs upon them.
- **Usage:** Uses 1 Channel Divinity

#### Hammer of Justice (Athore)
...
- **Damage Type:** Positive (energy), Half DR
- **Usage:** Uses 1 Channel Divinity
...
#### Kismet's Touch (Enschede)
- **Action Cost:** [Reaction]
- **Trigger:** Any roll is made (yours or another creature's) that you can see
- **Range:** 60 feet
- **Effect:** After seeing the result, you can declare it an automatic success (both dice count as successes) or automatic failure (both dice count as failures), regardless of the actual roll. Fate itself bends to your will for one crucial moment. This is Enschede's most powerful gift.
...
- **Damage Type:** Negative (energy), Half DR
- **Usage:** Uses 1 Channel Divinity
...
#### Knowledge of the Ages (Shu-Jahan)
- **Action Cost:** 1 [Interact] action
- **Range:** Self
...
- **Action Cost:** 1 [Minor] action
- **Range:** Self
- **Effect:** For 10 minutes, you gain the following benefits: You automatically see through all illusory effects (no check needed). You know when creatures speak lies (though not what the truth is). You have Fortune on Perception and Investigate checks. Your eyes glow brighter than normal as enlightenment fills you.
- **Usage:** Uses 1 Channel Divinity
...
- **Effect:** Touch a weapon or piece of armor. For 1 minute, choose one benefit: Weapons deal +1d8 damage on next hit, OR Armor grants +1 DR. The infusion ends after triggering once or when duration expires. Violet light flows into the item like liquid energy, and it glows faintly while holding your magic.

### Sorcerous Origin Abilities

#### Harmonic Weaving
- **Action Cost:** [Free] (declared when making weaving roll)
- **Frequency:** Wisdom + Tier times per long rest
- **Effect:** When you make a weaving roll, you can declare "Harmonic" to reroll one die (Potential OR Mastery, your choice). You must take the new result. Your perfect self-knowledge allows you to adjust reality's response to your will.

### Eldritch Pact Abilities

#### Scavenged Power (Survivor's Bargain)
- **Action Cost:** [Free] (triggers when creature reduced to 0 HP)
- **Effect:** When you reduce a hostile creature to 0 HP, immediately regain Energy equal to your tier (minimum 2), and gain temporary HP equal to your Charisma + tier. Your patron feeds on endings, and so do you.

#### Borrowed Vitality (Desperate Deal)
- **Action Cost:** 1 [Combat] action
- **Range:** Touch or Self
- **Frequency:** Once per short rest
- **Effect:** Heal yourself or touched ally for HP equal to Charisma × tier. Life borrowed is life shared. Your pact allows you to channel positive energy through desperation.

#### Void Resonance (Answered Cry)
- **Effect:** Whenever you weave using Air or Space as primary energy, you can target one additional creature within range (make separate weaving rolls for each). The void spreads your intent beyond normal limits. This is a passive ability that enhances your casting.

#### Void Speech (Answered Cry)
- **Effect:** You can communicate telepathically with any creature you can see within 30 feet. The void answered your cry and now serves as a conduit for your thoughts. This is a passive ability.

#### Unstable Surge (Stolen Shard)
- **Effect:** Whenever you weave using your Primary Energy (Fire), add +4 damage OR extend duration by 1 round. Power stolen doesn't flow smoothly—it erupts with raw force. This is a passive ability.

#### Shard's Terror (Stolen Shard)
- **Action Cost:** 1 [Combat] action
- **Range:** 30 feet
- **Frequency:** Once per short rest
- **Effect:** Target within 30 feet makes Will save (your Charisma + Fire Mastery vs their Wisdom + Luck). If you win by 1+ successes, target is Frightened for 1 minute (they can repeat save each turn). The stolen power within you manifests as pure terror.