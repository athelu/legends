...
**Saving Throw:** None
**Targeting Success Scaling:** 0 = fails, 1 = 10 minutes, 2= until dispelled, 3 = add 1 additional penalty (+5 total)
...
**Saving Throw:** None
**Targeting Success Scaling:** 0 = fails, 1 = 2ft cube, 2= 5ft cube, 3 = 10ft cube
...
**Saving Throw:** None
**Targeting Success Scaling:** 0 = fails, 1 = 100 feet, 2= 500 feet, 3 = 1000 feet
...
**Targeting Success Scaling:** 0 = fails, 1 = half damage (2), 2= full damage (4), 3 = enhanced damage (8 total)
...
**Saving Throw:** None
**Targeting Success Scaling:** 0 = fails, 1 = 1 minute, 2= full effect, 3 = 1 hour
...
**Saving Throw:** Fortitude
**Targeting Success Scaling:** 0 = fails, 1 = 5 feet, 2= 10 feet, 3 = 15 feet + prone
...
**Saving Throw:** None
**Targeting Success Scaling:** 0 = fails, 1 = mishap, 2= Very familiar, 3 = visited a few times
...
**Damage Type:** Thunder (sonic energy)
**DR Interaction:** Ignore
**Targeting Success Scaling:** 0 = fails, 1 = 1/2 damage (6), 2= full damage (12), pushed 10 feet, 3 = enhanced damage (20), pushed 10 feet + prone
...
**Saving Throw:** Will
**Targeting Success Scaling:** 0 = fails, 1 = 1 round, 2= 1 minute, 3 = 10 minutes + incapacitated
...
**Damage Type:** Force
**DR Interaction:** Ignore
**Targeting Success Scaling:** 0 = fails, 1 = 1 dart (4), 2= 3 darts (4 x3), 3 = 4 darts (4 x4)
...
**Targeting Success Scaling:** Must equal or exceed original weaving successes to dispel
...
**Total Cost:** 6 Energy
**Action:** Complex weave (2 actions) to cast, then complex weave (1 action) to discharge
...
**DR Interaction:** Half DR
**Targeting Success Scaling:** 0 = fails, 1 = 6 damage (heal 3), 2= 12 damage (heal 6), 3 = 16 damage (heal 8)
...
**DR Interaction:** Half DR
**Targeting Success Scaling:** 0 = fails, 1 = half damage (8), 2= full damage (16), 3 = enhanced damage (24) + ignited
...
**Weaving Roll:** Space Potential + Space Mastery / Time Potential + Time Mastery
**Targeting Roll:** Casting Stat + Space Mastery
**Description:** Create invisible wall of force at medium range up to 80 feet long, 20 feet high, 1 foot thick (or hemisphere 10 feet diameter, or sphere 10 feet diameter). Totally blocks physical and magical effects. Can be dispelled and Disintegrate destroys it. Nothing can pass through.
**Saving Throw:** None
**Targeting Success Scaling:** 0 = fails, 1 = 1 minute, 2= 10 minutes, 3 = 1 hour
...
**Saving Throw:** None
**Targeting Success Scaling:** 0 = fails, 1 = 1 reflection, 2= 3 reflections, 3 = 4 reflections (10 minutes)
...
**Saving Throw:** Reflex
**Targeting Success Scaling:** 0 = fails, 1 = 10ft radius (1 round), 2= 20ft radius (1 minute), 3 = 30ft radius (10 minutes)
...
**Saving Throw:** None
**Targeting Success Scaling:** 0 = fails, 1 = one-way message only, 2= close range (30 ft), 3 = medium range (60ft)
