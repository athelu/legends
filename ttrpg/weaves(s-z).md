...
**Supporting Energy:** Time 3 (duration 10 minutes)  
**Range:** Special (moves up to 30 feet per round)  
**Duration:** 10 minutes  
**Total Cost:** 8 Energy  
...
**Supporting Energy:** Space 4 (medium range + 15ft radius) / Time 3 (duration 10 minutes)  
...
**Effect:** Touch a target and drain their life force with necrotic energy. Target takes 4 necrotic damage. You regain HP equal to half the damage dealt (rounded down). This is an attack weave—no saving throw allowed.  
...
**Supporting Energy:** Space 3 (close range + 20ft radius) / Time 2 (duration 10 minutes)  
...
**Action:** Simple weave (1 action)  
**Weaving Roll:** Space Potential + Space Mastery / Time Potential + Time Mastery  
**Effect:** Create a spectral hand at close range that can manipulate objects (lift up to 10 lbs, open unlocked doors, retrieve items). Cannot attack or activate magic items. Can move hand up to 30 feet each round as [Free] action.  
**Saving Throw:** None (utility weave)  
**Success Scaling:** 0 = fails, 1 = 1 round, 2 = full effect, 3 = 10 minutes, 4 = 25 lbs capacity (1 hour)
...
**Action:** Complex weave (2 actions)  
**Weaving Roll:** Space Potential + Space Mastery / Time Potential + Time Mastery  
**Effect:** Create invisible, mindless, shapeless force within close range. Has AC/DR 2, 4 HP, Strength 2, can't attack. Can perform simple tasks: fetch, clean, mend, fold, light fires, serve food. Can carry 30 lbs or drag 60 lbs. Command as [Minor] action. Moves 15 feet per round. Vanishes if reduced to 0 HP or when weave ends.  
**Saving Throw:** None (creates servant)  
**Success Scaling:** 0 = fails, 1 = 10 minutes, 2 = full effect, 3 = 8 hours, 4 = can create 2 servants (or 1 servant with Strength 4)  
...
**Action:** Complex weave (2 actions)  
**Weaving Roll:** Earth Potential + Earth Mastery  
**Effect:** Reshape natural stone into any form (crude weapons, doors, passages). More effective than Shape Stone on natural stone. Changes are permanent.  
**Saving Throw:** None (environmental manipulation)  
**Success Scaling:** 0 = fails, 1 = 2ft cube, 2 = 5ft cube, 3 = 10ft cube, 4 = 20ft cube

---

### Suggestion
**Primary Energy:** Negative 4 (planting compulsion in mind)  
**Supporting Energy:** Space 2 (medium range) / Time 3 (duration up to 8 hours)  
**Range:** Medium, 60 ft.  
**Duration:** 8 hours (or until completed)  
**Total Cost:** 9 Energy  
**Action:** Complex weave (2 actions)  
**Weaving Roll:** Negative Potential + Negative Mastery / Space Potential + Space Mastery / Time Potential + Time Mastery  
**Effect:** Target at medium range makes Will save. Compare your weaving successes to their save successes. If you have more, you suggest a course of activity (1-2 sentences) that sounds reasonable. Target pursues the activity for the duration or until completing it. Obviously harmful suggestions end the weave. Creatures immune to charm are immune.  
**Saving Throw:** Will (to resist mental compulsion)  
**Success Scaling:** 0 = no effect, 1 = 1 hour, 2 = full effect (8 hours), 3 = 24 hours, 4 = very hard to resist (they need Fortune on future saves if conditions change)  

---

### Suggestion, Mass
**Primary Energy:** Negative 6 (planting compulsion in multiple minds)  
**Supporting Energy:** Space 3 (medium range + up to 12 targets) / Time 4 (duration 24 hours)  
**Range:** Medium, 60 ft. (up to 12 creatures)  
**Duration:** 24 hours (or until completed)  
**Total Cost:** 13 Energy  
**Action:** Complex weave (2 actions)  
**Weaving Roll:** Negative Potential + Negative Mastery / Space Potential + Space Mastery / Time Potential + Time Mastery  
**Effect:** Up to 12 creatures you can see at medium range make Will saves. Compare your weaving successes to each target's save successes. Those you beat follow your suggested course of activity (1-2 sentences) that sounds reasonable. Targets pursue activity for 24 hours or until completing it. Obviously harmful suggestions end weave for that target. Creatures immune to charm are immune.  
**Saving Throw:** Will (to resist mental compulsion)  
**Success Scaling:** 0 = no effect (per target), 1 = 1 hour, 2 = 24 hours, 3 = 10 days, 4 = 30 days (extremely powerful compulsion)  

---

### Summon Elemental
**Primary Energy:** Matching elemental energy (Earth/Air/Fire/Water) 6  
**Supporting Energy:** Space 1 (close range) / Time 3 (duration 10 minutes)  
**Range:** Close, 30 ft.  
**Duration:** 10 minutes  
**Total Cost:** 10 Energy  
**Action:** Complex weave (2 actions)  
**Weaving Roll:** Primary Potential + Primary Mastery / Space Potential + Space Mastery / Time Potential + Time Mastery  
**Effect:** Summon an elemental matching your Primary Energy at close range. Elemental has HP = (Your Potential × 6), deals 10 damage, uses your Mastery for attacks, and has special abilities based on type. You can command it as [Free] action. If concentration breaks, elemental acts independently.  
**Saving Throw:** None (summoning weave)  
**Success Scaling:** 0 = fails, 1 = 1 minute, 2 = full effect, 3 = 1 hour, 4 = 8 hours or 2 elementals
...
**Weaving Roll:** Space Potential + Space Mastery / Time Potential + Time Mastery  
**Effect:** Move object up to 500 lbs up to 30 feet per round at medium range. Can use to restrain creature (opposed check: your Space Mastery vs their Athletics). Restrained creature can retry each round (1 success escapes).  
**Saving Throw:** Athletics vs Space Mastery (if restraining creature)  
**Success Scaling:** 0 = fails, 1 = 100 lbs (1 minute), 2 = 500 lbs (full effect), 3 = 1000 lbs (1 hour), 4 = 2000 lbs and can fine manipulate (8 hours)
...
**Action:** Complex weave (2 actions)  
**Weaving Roll:** Space Potential + Space Mastery  
**Effect:** Push or pull one creature/object up to 10 feet. Target makes Fortitude save to resist (if creature). Can also be used to knock prone (Reflex save). Compare your weaving successes to their save successes.  
**Saving Throw:** Fortitude (to resist forced movement) or Reflex (to avoid being knocked prone)  
**Success Scaling:** 0 = no effect, 1 = 5 feet, 2 = 10 feet, 3 = 15 feet, 4 = 20 feet or knock prone
...
**Action:** Complex weave (2 actions)  
**Weaving Roll:** Space Potential + Space Mastery  
**Effect:** Instantly transport to destination on same plane. Success depends on familiarity: Very familiar (2 successes needed): home, place visited often; Seen casually (3 successes): seen a few times; Viewed once (4 successes): seen once or through scrying; Description only (4 successes, Misfortune): never seen, described only.  
**Saving Throw:** None (willing targets only)  
...
**Action:** Complex weave (2 actions)  
**Weaving Roll:** Air Potential + Air Mastery / Space Potential + Space Mastery  
**Effect:** All creatures in 15-foot cube originating from you take 12 thunder damage and make Fortitude saves. Compare your weaving successes to their save successes. Those you beat are pushed 10 feet away from you. Unsecured objects are also pushed.  
**Saving Throw:** Fortitude (to resist force and reduce damage)  
**Damage Type:** Thunder (sonic energy)  
**DR Interaction:** Full DR applies (12 thunder damage vs DR 4 becomes 12 - 4 = 8 damage)  
**Success Scaling:** 0 = half damage (6), no push, 1 = 3/4 damage (9), pushed 5 feet, 2 = full damage (12), pushed 10 feet, 3 = +8 damage (20 total), pushed 15 feet, 4 = +8 damage (20 total), pushed 20 feet + Prone  
...
**Effect:** Touch a creature. For the duration, target can understand and speak any language. Doesn't help with written languages.  
**Saving Throw:** None (beneficial enhancement)  
**Success Scaling:** 0 = fails, 1 = 10 minutes (understand only), 2 = full effect, 3 = 8 hours, 4 = can read/write all languages too  
...
**Success Scaling:** 0 = no damage, 1 = half (4), 2 = full (8), 3 = +8 and Poisoned (16 total), 4 = +16 and Poisoned (24 total)  
**Poisoned Condition (at Net 3+):** Target has Misfortune on all rolls until the end of their next turn. At Net 4, duration extends to 1 minute (can save at end of each turn, 1 success ends).
...
**Supporting Energy:** Space 1 (close range) / Time 2 (duration up to 1 minute)  
**Range:** Close, 30 ft.  
**Duration:** 1 minute (until save succeeds)  
**Total Cost:** 5 Energy  
**Action:** Complex weave (2 actions)  
...
**Note:** Creatures with Intelligence 1 aren't affected.
---
...
**Scaling:** +1 Energy for +1 dart (max 8 darts at 10 Energy)  
...
**Supporting Energy:** Space 4 (medium range + wall area) / Time 3 (duration 10 minutes)  
...
**Success Scaling:**  
- **Near wall (16 base):** 0 = no damage, 1 = half (8), 2 = full (16), 3 = +8 (24), 4 = +16 (32)  
- **Passing through (24 base):** 0 = no damage, 1 = half (12), 2 = full (24), 3 = +8 (32), 4 = +16 (40)  
**Ignited Condition (at Net 4 when passing through):** Target takes 1d8 fire damage at start of each turn. Can use 1 action to make Reflex save (1 success ends).
...
**Action:** Complex weave (2 actions)  
**Weaving Roll:** Space Potential + Space Mastery / Time Potential + Time Mastery  
**Effect:** Create invisible wall of force at medium range up to 80 feet long, 20 feet high, 1 foot thick (or hemisphere 10 feet diameter, or sphere 10 feet diameter). Totally blocks physical and magical effects. Can't be dispelled but Disintegrate destroys it. Nothing can pass through.  
...
**Supporting Energy:** Space 4 (medium range + wall area) / Time 2 (duration 1 minute)  
**Range:** Medium, 60 ft. (60 feet long, 20 feet high OR hemisphere 10 feet diameter)  
**Duration:** 1 minute  
**Total Cost:** 11 Energy  
**Action:** Complex weave (2 actions)  
**Weaving Roll:** Water Potential + Water Mastery / Space Potential + Space Mastery / Time Potential + Time Mastery  
**Effect:** Create wall of ice at medium range up to 60 feet long, 20 feet high, 1 foot thick (or hemisphere 10 feet diameter). Each 10ft section has HP = 12 + Water Potential, DR 2 vs nonmagical damage. Creatures within area when created make Reflex save or take 8 cold damage. Wall melts naturally over time.  
**Saving Throw:** Reflex (when wall is created in your space)  
**Damage Type:** Cold (energy)  
**DR Interaction:** Half DR (8 cold damage vs DR 4 becomes 8 - 2 = 6 damage)  
**Success Scaling:**  
- **Duration/HP:** 0 = fails, 1 = 1 round (6 HP sections), 2 = full effect (12 HP sections), 3 = 10 minutes (24 HP, double), 4 = 1 hour (36 HP, triple, DR 4)  
- **Initial damage:** 0 = no damage, 1 = half (4), 2 = full (8), 3 = +8 (16), 4 = +16 (24)
...
**Action:** Complex weave (2 actions)  
**Weaving Roll:** Earth Potential + Earth Mastery / Space Potential + Space Mastery  
**Effect:** Create permanent wall of stone at medium range up to 60 feet long, 20 feet high, 6 inches thick (or 30 feet long and 1 foot thick). Each 10ft section has HP = 16 + Earth Potential, DR 4. Can shape into crenellations, bridges, etc.  
**Saving Throw:** None (creates barrier)  
**Success Scaling:** 0 = fails, 1 = 1 minute duration only, 2 = permanent, 3 = double HP, 4 = triple HP and can create complex shapes
...
**Success Scaling:** 0 = fails, 1 = 1 minute, 2 = full effect, 3 = 1 hour, 4 = 8 hours or 20ft radius
...
**Success Scaling:** 0 = fails, 1 = 1 minute, 2 = full effect, 3 = 1 hour, 4 = blocks weaves of 6 Energy or less (8 hours)
...
**Success Scaling:** 0 = fails, 1 = 1 reflection, 2 = 3 reflections, 3 = 5 reflections (10 minutes), 4 = 8 reflections (1 hour)
...
**Weaving Roll:** Air Potential + Air Mastery / Space Potential + Space Mastery  
**Effect:** Point at a creature within close range and whisper a message. Target (and only target) hears the message and can whisper a reply that only you hear. Weave transmits through most barriers but is blocked by 1 foot of stone, 1 inch of common metal, thin sheet of lead, or 3 feet of wood.  
**Saving Throw:** None (communication)  
**Success Scaling:** 0 = fails, 1 = one-way message only, 2 = full effect (can reply), 3 = medium range (60ft), 4 = long range (120ft)  
...
**Supporting Energy:** Space 3 (close range + 15ft radius) / Time 2 (duration 10 minutes)  
...
**Effect:** Create 15-foot radius sphere at close range. All creatures in area make Will saves. Compare your weaving successes to each target's save successes. Those you beat can't speak deliberate lies while in the zone. They can be evasive, remain silent, or speak misleading truths. You know which creatures failed their saves. Creatures immune to charm are immune.  
**Saving Throw:** Will (to resist compulsion to speak truth)  
**Success Scaling:** 0 = no effect, 1 = 1 minute, 2 = full effect, 3 = 1 hour, 4 = 20-foot radius  